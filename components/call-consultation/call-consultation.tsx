...
export default function Consultations() {
  return (
    <>
      <Head>
        <title>Premium Astrology Consultations | Expert Guidance</title>
        <meta name="description" content="Book personalized astrology consultations for love, career, finance, marriage and more with our expert astrologers." />
      </Head>
