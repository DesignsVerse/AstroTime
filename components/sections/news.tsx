      ...
      <section className={`${merriweather.className} bg-white text-[#1a2238] max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-20`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-16">
          ...
          <article className="group transition-all duration-300 hover:-translate-y-2">
            <div className="relative rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300">
              <Image
                ...
                width={600}
              />
              <div className="absolute inset-0 flex justify-center items-center bg-[#800000]/60 rounded-lg cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            ...
            <p className="text-[#800000] font-semibold mt-6 mb-2 select-none cursor-default">Jul 27</p>
            <h3 className="text-xl font-semibold mb-3 leading-snug group-hover:text-[#800000] transition-colors duration-300">What&apos;s your horoscope..?</h3>
            ...
            <a className="text-[#800000] font-semibold select-none cursor-pointer hover:underline flex items-center gap-2" href="#">
          ...
          <article className="group transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-[#800000] font-semibold mt-6 mb-2 select-none cursor-default">Jul 27</p>
            <h3 className="text-xl font-semibold mb-3 leading-snug group-hover:text-[#800000] transition-colors duration-300">Numbers are chosen from your destiny</h3>
            <p className="text-[#6b6b7b] mb-6 leading-relaxed">
          ...
          <article className="group transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-[#800000] font-semibold mt-6 mb-2 select-none cursor-default">Jul 27</p>
            <h3 className="text-xl font-semibold mb-3 leading-snug group-hover:text-[#800000] transition-colors duration-300">Let&apos;s make the future more interesting</h3>
            <p className="text-[#6b6b7b] mb-6 leading-relaxed">
        ...
        <div className="flex justify-center mt-20">
          <button className="bg-[#800000] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#800000] transition-colors duration-300 shadow-md hover:shadow-lg">
            View All News
          </button>
        </div>
      </section>
