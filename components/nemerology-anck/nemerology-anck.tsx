...
export const metadata: Metadata = {
  title: 'Numerology Insights - Astroank | Best Astrologer in Ujjain',
  description:
    'Discover your destiny with Astroank’s numerology services, led by Astrologer Deepak Goutam. Explore Vedic numerology, life path numbers, and name analysis in Ujjain.',
  keywords: [
  ...
  openGraph: {
    title: 'Numerology Insights - Astroank | Best Astrologer in Ujjain',
    description:
      'Unlock your life’s secrets with Astroank’s numerology, led by Astrologer Deepak Goutam. Vedic numerology, life path numbers, and name analysis in Ujjain.',
    url: 'http://astroank.com/nemerology-anck',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Astroank Numerology Services',
      },
    ],
    siteName: 'Astroank',
  },
  twitter: {
    ...
    title: 'Numerology Insights - Astroank | Best Astrologer in Ujjain',
    description:
      'Explore Vedic numerology with Astroank in Ujjain, led by Astrologer Deepak Goutam. Discover life path numbers and name analysis.',
    images: ['http://astroank.com/images/astroank-logo.jpg'], // Replace with actual image URL
  },
  alternates: {
    canonical: 'http://astroank.com/nemerology-anck',
    languages: {
      'en-US': 'http://astroank.com/nemerology-anck',
    },
  },
};
