...
export const metadata: Metadata = {
  title: 'Panchang & Numerology - Astroank | Best Astrologer in Ujjain',
  description:
    'Explore daily panchang and numerology insights with Astroank, led by Astrologer Deepak Goutam. Discover tithi, nakshatra, life path numbers, and more in Ujjain.',
  keywords: [
    ...
    'Panchang Ujjain',
    'Daily Panchang Online',
    'Vedic Numerology Ujjain',
    'Life Path Number Analysis',
    'Name Numerology Ujjain',
    'Numerology Consultation Ujjain',
    'Tithi and Nakshatra Ujjain',
    'Auspicious Timings Ujjain',
  ],
  ...
  openGraph: {
    title: 'Panchang & Numerology - Astroank | Best Astrologer in Ujjain',
    description:
      'Get daily panchang and numerology insights from Astroank in Ujjain, led by Astrologer Deepak Goutam. Explore tithi, nakshatra, and life path numbers.',
    url: 'http://astroank.com/panchang',
    type: 'website',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Astroank Panchang & Numerology',
      },
    ],
    siteName: 'Astroank',
  },
  twitter: {
    ...
    title: 'Panchang & Numerology - Astroank | Best Astrologer in Ujjain',
    description:
      'Discover daily panchang and numerology with Astroank in Ujjain, led by Astrologer Deepak Goutam. Tithi, nakshatra, and life path insights.',
    images: ['http://astroank.com/images/astroank-logo.jpg'], // Replace with actual image URL
  },
  alternates: {
    canonical: 'http://astroank.com/panchang',
    languages: {
      'en-US': 'http://astroank.com/panchang',
    },
  },
};
              ...
              <div className="p-6">
                <div className="flex items-center gap-6 mb-6">
                  ...
                  <div className="flex-1">
                    <p className="text-lg">{numerologyData.prediction}</p>
                  </div>
                </div>
