...
const Header: FC = () => {
  ...
  // Updated navigation items with categories
  const navItems = [
  ...
  return (
    ...
    >
      ...
      <div
        ref={contactBarRef}
        className={`bg-[#1C1C1C] py-2 px-4 transition-all duration-500 fixed w-full top-0 z-50 ${
      ...
      <nav
        ...
        } ${!isContactBarVisible ? "mt-0" : "mt-[52px] sm:mt-8"}`}
      >
                  ...
                  <Link
                    ...
                    className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                      item.highlight 
                        ...
                        : "text-gray-700 hover:text-[#800000] hover:bg-gray-100"
                    }`}
                  >
                    {item.name}
                  </Link>
                ...
                <nav className="px-2 space-y-1">
                  {navItems.map((item) => (
                    <Link
                      key={item.name}
                      href={item.href}
                      className={`block px-3 py-3 rounded-md text-base font-medium mx-2 transition-colors ${
                        item.highlight 
