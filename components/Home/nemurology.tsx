    ...
    <section className="w-full min-h-screen md:min-h-[80vh] flex flex-col md:flex-row items-center justify-between bg-[#FCFAF8] py-12 md:py-16 px-4 md:px-8 lg:px-16 relative overflow-hidden">
      ...
      >
        <motion.div variants={itemVariants}>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#5a0808] mb-4 md:mb-6 font-serif text-center md:text-left">
            ...
            <br className="hidden sm:block" /> Through <span className="relative inline-block">
              Numerology
      ...
      >
        <div className="w-full max-w-md md:max-w-lg h-[250px] sm:h-[300px] md:h-[380px] bg-gradient-to-br from-[#5a0808] to-[#8b1e1e] rounded-xl md:rounded-2xl shadow-lg md:shadow-2xl border-2 border-[#f0e6d9] flex items-center justify-center overflow-hidden relative group">
          ...
          {/* Animated crystal ball effect */}
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="absolute w-32 h-32 md:w-40 md:h-40 rounded-full border-2 border-white/30 animate-pulse"></div>
            <GiCrystalBall className="absolute text-white/10 text-9xl" />
          </div>
          ...
          {/* Decorative elements */}
          <div className="absolute top-3 left-3 md:top-4 md:left-4 text-white font-serif text-xs md:text-sm tracking-wider">Numerology Revealed</div>
