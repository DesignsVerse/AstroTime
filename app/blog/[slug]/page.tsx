            ...
            <div className="lg:w-2/3">
              <section className={`${merriweather.className} relative text-[#1a2238]`}>
                ...
                {post.content.backlink && (
                  <div className="bg-[#f8e1e1] p-4 rounded-lg border-l-4 border-[#800000] mb-12">
                    <h3 className={`${montserrat.className} text-lg font-semibold mb-2`}>
                      <Link href={post.content.backlink.url} className="text-[#800000] hover:underline">
                        {post.content.backlink.heading}
                      </Link>
                    </h3>
                    <p className="text-sm text-[#1a2238] line-clamp-2">
                      {post.content.backlink.description}
                    </p>
                  </div>
                )}
