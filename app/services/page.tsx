          ...
          <div className="relative p-2 sm:p-6 md:p-8 rounded-xl sm:rounded-3xl">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-6 md:gap-8 relative">
              {services.map((service) => (
                <div
                  key={service.id}
                  className="relative bg-white rounded-lg sm:rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group border border-gray-200 min-h-[270px] sm:min-h-[320px] flex flex-col"
                >
                  {/* Card background */}
                  ...
                  <div className="relative p-3 sm:p-5 flex flex-col items-center text-center h-full">
                    ...
                    <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-5 line-clamp-2">
                      {service.description}
                    </p>
